// src/data/radioPlayer.js
//
// Player de rádio ao vivo no estilo do radio.garden, DOM puro (sem Cesium):
// card embaixo no centro, play/pausa, setas que zapeiam pelas estações ao vivo
// do estado inteiro, volume lembrado, chiado de estática (WebAudio) enquanto a
// emissora sintoniza, lista das estações do município e contato do estúdio.
// Usado pela camada Cesium (datageoRadios.js) e pelo protótipo MapLibre
// (src/maplibre/layers/conectividadeRadios.js), que só dizem qual município
// abrir e recebem de volta o município selecionado (onSelectionChange).
//
...
import { contactLines, isLive, stationBadges } from './radioContact.js';
...
export function createPlayer({ onSelectionChange }) {
