...
import { fetchFiresPayload } from './datageoClient.js';
...
// (fetchFiresPayload reproduz o contrato do antigo proxy /api/firms).
const FIRMS_API_URL = '/api/firms'; // mantido apenas para referencia historica
...
export function createFirmsHeatmapLayer({
  ...
  async function loadHeatmap() {
    ...
    try {
      const payload = await fetchFiresPayload();
      _keyRequired = false;
      _error = null;
