...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  // Camadas DataGeo PR (fusao c2-parana — ver PLANO_FUSAO.md secao 3)
  Object.freeze({ id: 'datageo-clima', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-rios', token: 'h', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'datageo-ventos', token: '3', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-rodovias', token: '4', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-armazens', token: '5', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-agroindustrias', token: '6', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'datageo-precipitacao', token: 'C', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-conectividade', token: 'D', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-clima-historico', token: 'E', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'datageo-estradas', token: 'J', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-car', token: 'K', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-radios', token: 'L', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-estradas-conveniadas', token: 'M', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-agroindustrias-idr', token: 'N', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-rotas-turisticas', token: 'O', disposition: 'enabled-only' }),
  Object.freeze({ id: 'datageo-regionais-idr', token: 'P', disposition: 'enabled-only' }),
